...
class AdminAnimalsAdapter(
    ...
    inner class AnimalViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(animal: Animal) {
            ...
            // Pet info (type, breed, age, size, shelter)
            ...
            // Location (first 2 parts of address)
